...
const Australia = ({ navigation }) => {
    ...
    function getNewsFromAPI() {
        newAPI.get('https://newsapi.org/v2/top-headlines?country=au&apiKey=f402164ccf374ca4bdbcca0e1dfc64d3')
        ...
        <ScrollView style={{ backgroundColor: theme.backColor }}>
            <View style={styles.smallheader}>
                <Image
                    ...
                    source={require('../../assets/flags/aus.png')} />
                <Text style={styles.textsh}>Australia</Text>
            </View>
