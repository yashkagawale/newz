...
const NewZeal = ({ navigation }) => {
    ...
    function getNewsFromAPI() {
        newAPI.get('https://newsapi.org/v2/top-headlines?country=nz&apiKey=f402164ccf374ca4bdbcca0e1dfc64d3')
        ...
        <ScrollView style={{ backgroundColor: theme.backColor }}>
            <View style={styles.smallheader}>
                <Image
                    ...
                    source={require('../../assets/flags/nz.png')} />
                <Text style={styles.textsh}>New Zealand</Text>
            </View>
