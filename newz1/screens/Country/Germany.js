...
const Germany = ({ navigation }) => {
    ...
    function getNewsFromAPI() {
        newAPI.get('https://newsapi.org/v2/top-headlines?country=de&apiKey=f402164ccf374ca4bdbcca0e1dfc64d3')
        ...
        <ScrollView style={{ backgroundColor: theme.backColor }}>
            <View style={styles.smallheader}>
                <Image
                    ...
                    source={require('../../assets/flags/gm.png')} />
                <Text style={styles.textsh}>Germany</Text>
            </View>
